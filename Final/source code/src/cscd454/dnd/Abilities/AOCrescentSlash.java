...
public class AOCrescentSlash extends AOEOffensiveAbility
{

	public AOCrescentSlash(CharacterEntity master)
	{
		super(master);
		_type = CharacterType.ROGUE;
		checkCompatibility();
		_name = "Crescent Slash";
		_description = "Waves blades dealing damage to all enemies in the area.";
	}
